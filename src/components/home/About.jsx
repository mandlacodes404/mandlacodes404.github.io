  ...
  return (
    <section id="about" className="px-10 py-16">
      <div className="text-base text-text-secondary leading-loose space-y-6 max-w-md">
        <p>
          Hi there! my name is Mandla Mahlangu. I'm an Electrical Engineering
          student at Wits University, but a lot of my time outside the
          classroom is spent building software. I enjoy taking an idea
          and figuring out how to turn it into something that actually
          works.
        </p>
        <p>
